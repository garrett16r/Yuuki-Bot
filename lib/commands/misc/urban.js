...
class Chuck extends commandos.Command {
    ...
    async run(msg, {keyword}) {
        ...
        let res = await fetch(`https://mashape-community-urban-dictionary.p.rapidapi.com/define?term=${keyword}`, {headers: {"x-rapidapi-host": "mashape-community-urban-dictionary.p.rapidapi.com", "x-rapidapi-key": process.env.X-RAPIDAPI-KEY}})
