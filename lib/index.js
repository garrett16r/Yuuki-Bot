...
const { elementMain } = require("./natElementalist.js");
const { timeCapsuleCheck } = require("./timeCapsuleChecker.js");
const { mcStatusMain } = require("./mcServerStatus.js");
...
let config = async () => {
  try {
    ...
    await timeCapsuleCheck(client);
    await mcStatusMain(client);
  } catch(err) {
    console.error(err);
  }
};
