...
var { COMMANDS_ID } = require("./constants.js");
...
client.dispatcher.addInhibitor(msg => {
  return (msg.channel.id !== COMMANDS_ID && !msg.content.includes(".yu clear") && !msg.content.includes(".yu say") && !msg.content.includes(".yu setchannel"));
});
